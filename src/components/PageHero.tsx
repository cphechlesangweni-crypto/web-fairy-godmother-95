    ...
    <section className="relative bg-hero-gradient text-secondary-foreground overflow-hidden">
      ...
      <div className={`container relative py-20 md:py-28 ${hasImage ? "grid lg:grid-cols-[1.2fr_1fr] gap-12 items-center" : ""}`}>
        <div>
          ...
          <h1 className={`font-display text-4xl md:text-5xl ${hasImage ? "lg:text-6xl" : "lg:text-7xl"} font-medium max-w-4xl text-balance leading-[1.05]`}>
            {title}
          </h1>
        ...
        {hasImage && (
          <div className="relative">
            <div className="absolute -inset-4 bg-primary/20 rounded-[2rem] blur-2xl" />
            <div className="relative rounded-[1.5rem] overflow-hidden shadow-elegant border border-secondary-foreground/10 aspect-square lg:aspect-[4/5]">
              <img
                src={image}
                alt={imageAlt || ""}
                width={1400}
